---
title: "visualizing text +<br>network data"
date: '2021-10-15'
output:
...
love_actually <- read_csv(here::here("14-visualize-text-network", "data/love-actually.csv"))
```
...
```{r message = FALSE}
main_characters <- read_csv(here::here("14-visualize-text-network", "data/love-actually-cast.csv"))
```
