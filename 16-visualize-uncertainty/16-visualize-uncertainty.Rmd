...
.center[
```{r freq-waffle, fig.width = 4.5, fig.asp = 1, echo = FALSE, dev = "svg", out.width = "45%"}
...
.center[
```{r freq-waffle2, fig.width = 10, fig.asp = 0.45, echo = FALSE, dev = "svg", out.width = "90%"}
...
.center[
```{r everest-highest-point, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
...
.center[
```{r everest_margins, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(margins)
...
.center[
```{r everest_margins2, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(ggdist)
...
.center[
```{r everest_margins3, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(ggdist)
...
.center[
```{r everest_margins4, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r everest_margins5, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r everest_margins6, echo = FALSE, fig.width = 8, fig.asp = 0.5, dev = "svg", out.width = "70%"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r gapminder-regressions, echo = FALSE, message = FALSE, fig.width = 7, fig.asp = 0.65, dev = "svg", out.width = "70%"}
gapminder %>%
  filter(
    continent != "Oceania",
...
.pull-left[
```{r gapminder-regressions2, echo = FALSE, message = FALSE, fig.width = 7, fig.asp = 0.65, dev = "svg", out.width = "100%"}
gapminder %>%
  filter(
    continent != "Oceania",
    year %in% c(1952, 1967, 1982, 1997)
...
.pull-right[
<br>
```{r gapminder-summary, echo = FALSE, message = FALSE, fig.width = 7, fig.asp = 0.5, dev = "svg", out.width = "100%"}
gapminder %>%
...
.pull-right[
```{r gapminder-model-out, ref.label = "gapminder-model", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg", out.width = "100%"}
```
]
...
.pull-right[
```{r gapminder-halfeye-out, ref.label = "gapminder-halfeye", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg", out.width = "100%"}
```
]
...
.pull-right[
```{r gapminder-gradinterval-out, ref.label = "gapminder-gradinterval", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg", out.width = "100%"}
```
]
...
.pull-right[
```{r gapminder-quantiledots-out, ref.label = "gapminder-quantiledots", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg", out.width = "100%"}
```
]
...
.pull-right[
```{r gapminder-quantiledots2-out, ref.label = "gapminder-quantiledots2", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg", out.width = "100%"}
```
]
