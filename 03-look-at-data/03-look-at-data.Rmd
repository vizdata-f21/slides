...
.task[
Do you expect the following plots to be the same or different? If different, how? Discuss in a pair (or group) without running the code and sketch the resulting plots based on what you think the code will produce. Click [here](https://app.sli.do/event/rxg9buzy) to submit summary of discussion.
]
...
## Activity: Spot the difference III
